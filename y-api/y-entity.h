...
#define	MAP_SIZE 512  //The size of our *.RAW Heightmap
#define	STEP_SIZE 16    //Width and height of each quad
// This is half the width/height of the entire terrain
const float HALF_SIZE = (MAP_SIZE * STEP_SIZE) / 2.0f;
...
// desc: ...
//-----------------------------------------------------------------------------
class YTerrain : public YEntity
{
public:
    YTerrain();
    YTerrain(uint8_t * pHeightMap, bool render, bool shock);
    virtual ~YTerrain();
